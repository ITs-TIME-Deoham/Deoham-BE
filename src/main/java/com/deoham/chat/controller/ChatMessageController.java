...
public class ChatMessageController {
    ...
    public ApiResponse<ChatMessageResponse> sendMessage(
            @PathVariable UUID roomId, @Valid @RequestBody ChatMessageSendRequest request) {
    ...
    public ApiResponse<ChatAttachmentPresignResponse> presignAttachment(
            @PathVariable UUID roomId, @Valid @RequestBody ChatAttachmentPresignRequest request) {
        UUID userId = currentUserId();
